                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="build_price" id="build_price" class="form-control " value="">
                            </div>                            
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="build_lolfps" id="build_lolfps" class="form-control " value="">
                            </div>
                            <div class="form-group">
    ...
    $(function(){
        $("#submitbtn").click(function(){
            ...
            if($(".uploaded").children().length == 0) {
                ...
                flag = 1;
            } else if($(".uploaded").children().length != 4) {
                $(".alert-danger").html('This field 4 images is required.');
                $(".alert-danger").attr('style','display:""');
                flag = 1;
            } else {
                $(".alert-danger").html('');
