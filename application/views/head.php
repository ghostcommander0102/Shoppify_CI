                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <a href="cart.php" class="mernulist1-cart-for-mobile" ><img src="<?php echo base_url() ?>../assets/img/cart-icon.png"  alt="1"></a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                              <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="cart.php"> <img src="<?php echo base_url() ?>../assets/img/cart-icon.png" class="mernulist1-cart" alt="1"> </a>
                                </li>
