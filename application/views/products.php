<?php for ($i=0; $i < count($products); $i++) { ?>
    <section id="p1-latest5" class="product-<?php echo $i%2 == 0?'odd':'even' ?>">
        <div class="container">
        
            <div class="row <?php echo $i%2 == 0?'reverse':'' ?>">
                <div class="col-md-6 <?php echo $i%2 == 0?'odd':'even' ?>-top">
                    <div class="product-img-area">
                        <a href="./item.php?build_id=[fill-build_id]" ><img src="<?php echo base_url() ?>../assets/img/builds/<?php echo str_pad($products[$i]['build_id'],4, "0", STR_PAD_LEFT); ?>/1.png" alt="CGC [fill-build_name]"></a>
                    </div>
                </div>
                <div class="col-md-6 <?php echo $i%2 == 0?'odd':'even' ?>-bottom">
                    <div class="content-list-<?php echo $i%2 == 0?'odd':'even' ?>-area">
                        ...
                        <h2  class="<?php strlen($products[$i]['build_name']) > 10?'responsivesize50font':''; ?>"> <?php echo $products[$i]['build_name']; ?> </h2>
